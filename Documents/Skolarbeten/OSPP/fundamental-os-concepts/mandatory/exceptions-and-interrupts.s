...
main:
	...
	li $s0, 0x7fffffff  #translates to lui and ori when executed
...
todo_3:
	...
	# TIP 3: Use the ori (bitwise or immediate) instruction and store result in $s1.
 	...
 	# Update the memory mapped receiver control register.
        ...
        sw $s1, 0xffff0000 #address to memory mapped receiver control register
...
__kernel_entry_point:
	...
	mfc0 $k0, $13   #copy $13 value of the cause register from the coprocessor 0 to $k0
	
	# Mask all but the exception code (bits 2 - 6) to zero. 
	
	andi $k1, $k0, 0x00007c  #Si: make first two bits 0 in $k0. Put result in $k1
...
todo_4:
	...
	lw $k1, 0xffff0004 # TODO: Uncomment this instruction. Si: address to input char
...
todo_1:
        ...
        mtc0 $k0, $14 #Si: move from $k0 to $14 (EPC)
